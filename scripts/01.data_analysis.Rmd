...
patchpath <- p$Hyperglutamatergic + p$Hypoglutamatergic + plot_annotation("Pathways affected by selected metabolites") +plot_layout(guides = "collect") & theme(legend.position = 'bottom')
...
ggsave(file="paper/Figures/4.jpeg",plot=four4,       width = 300, 
       height = 200, 
       units = "mm", dpi = 300, scale = 0.8) 
...
ggsave(file=here("paper/Figures/2C.jpeg"),plot=two_c) 
ggsave(file=here("paper/Figures/2D.jpeg"),plot=two_d)   
...
ggsave(file=here("paper/Figures/2G.jpeg"),plot=two_g) 
ggsave(file=here("paper/Figures/2H.jpeg"),plot=two_h) 
